...
hero:
  ...
  text: Multi-platform AI API Proxy Gateway
  tagline: Unified Access · Smart Routing · Usage Monitoring
  actions:
    - theme: brand
      text: Quick Start
...
features:
  ...
  - icon: 🐳
    ...
    details: Docker images ready to use with Docker Compose, Nginx reverse proxy, and HTTPS support
---
