        ...
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 bg-zinc-900 dark:bg-zinc-100 rounded-xl flex items-center justify-center">
              <Server className="text-white dark:text-zinc-900 text-sm" />
            </div>
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <motion.h1
            ...
            className="text-5xl md:text-7xl font-black tracking-tighter text-zinc-900 dark:text-zinc-100 mb-4"
          >
            <div>Fiammetta</div>
            <div className="text-zinc-300 dark:text-zinc-600 -mt-4 md:-mt-6">
              Watcher Proxy
            </div>
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-lg text-zinc-500 dark:text-zinc-400 max-w-2xl mb-10 leading-relaxed"
          >
          ...
          >
            <Link
              href="#quickstart"
              className="inline-flex items-center gap-2 px-6 py-3 bg-zinc-900 dark:bg-zinc-100 text-white dark:text-zinc-900 rounded-2xl font-medium hover:opacity-90 transition-opacity"
            >
              <BookOpen size={18} />
              快速开始
            </Link>
            <Link
              ...
              target="_blank"
              className="inline-flex items-center gap-2 px-6 py-3 bg-zinc-100 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-300 rounded-2xl font-medium hover:bg-zinc-200 dark:hover:bg-zinc-700 transition-colors"
            >
              <GitFork size={18} />
              GitHub
            </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, i) => (
              <motion.div
                ...
                className="bg-white dark:bg-zinc-800 rounded-3xl border border-zinc-100 dark:border-zinc-700 p-8 hover:border-zinc-300 dark:hover:border-zinc-600 hover:shadow-lg transition-all duration-300"
              >
      ...
      <section id="quickstart" className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-zinc-900 dark:bg-zinc-800 rounded-3xl p-8 overflow-x-auto"
          >
